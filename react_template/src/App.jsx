          ...
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="text-center md:text-left mb-4 md:mb-0">
              <p className="text-gray-400">
                © 2024 <span className="text-blue-400 font-semibold">Raj Agarwal</span>. All rights reserved.
              </p>
            ...
            <div className="flex items-center space-x-6">
              {/* Social Links */}
              <a
                href="https://linkedin.com/in/raj-agarwal-b04563255"
                target="_blank"
              ...
              <a
                href="mailto:raj390504@gmail.com"
